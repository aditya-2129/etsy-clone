  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        {callbackUrl && (
          <p className="mt-1 text-xs text-[var(--etsy-orange)]">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs text-[var(--etsy-orange)] hover:underline"
              >
                Forgot password?
              </Link>
            </div>
            <Input
              ...
              disabled={isSubmitting}
              className={errors.password ? "border-[var(--etsy-error)] focus-visible:ring-[var(--etsy-error)]" : ""}
              {...register("password")}
            />
            {errors.password && (
              <p className="text-xs text-[var(--etsy-error)]" role="alert">
